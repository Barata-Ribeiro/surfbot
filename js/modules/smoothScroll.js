export default class SmoothScroll {
    ...
    scrollToSection(event) {
        ...
        // Verifica se o href começa com '#', o que significa que está na mesma página.
        if (href.startsWith('#')) {
            ...
            // Se o href não começar com '#', navegue para a página desejada
            // e adicione o parâmetro de consulta 'scrollTo' com o valor da âncora.
            window.location.href = `${href}?scrollTo=${encodeURIComponent(event.currentTarget.hash)}`;
        }
    }
